    ...
    return (
        <div className={`h-screen w-screen ${tvState.isOn && 'animated-bg'} overflow-hidden relative flex items-center justify-center`}>
            ...
            <button
                ...
                className="absolute bottom-4 lg:bottom-auto lg:top-4 right-4 z-[100] rotate-90 lg:rotate-0 bg-neutral-800/80 text-white p-2 rounded-full border border-neutral-600 hover:bg-neutral-700 transition-colors backdrop-blur-sm group"
            ...
            {/* Remote Overlay */}
            <div
                className={`absolute right-[6.5rem] bottom-[0.5rem] sm:right-[10rem] lg:right-[5rem] lg:bottom-[10rem] z-50 rotate-90 lg:rotate-0 transition-all duration-500 ease-in-out transform ${showRemote
